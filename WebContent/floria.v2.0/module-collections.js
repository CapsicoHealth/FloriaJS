 ...
 Array.prototype.getSE = function(obj, field, throwMsg)
  {
    ...
    {
      for (var i = 0; i < this.length; i++)
        if (this[i]!=null && this[i][field] == obj)
          return this[i];
    }
    if (throwMsg != null)
      FloriaDOM.alertThrow(throwMsg);
...
if (!Array.prototype.getSENoCase)
 Array.prototype.getSENoCase = function(obj, field, throwMsg)
  {
    obj = obj.toLowerCase();
    if (field == null)
     {
       for (var i = 0; i < this.length; i++)
         if (this[i] != null && this[i].toLowerCase() == obj)
           return this[i];
     }
    else
     {
       for (var i = 0; i < this.length; i++)
         if (this[i]!=null && this[i][field] != null && this[i][field].toLowerCase() == obj)
          return this[i];
     }
    if (throwMsg != null)
     FloriaDOM.alertThrow(throwMsg);
...
if (!Array.prototype.removeValueAll)
  Array.prototype.removeValueAll = function(val, field)
  {
    let firstVal = null;
    for (var i = 0; i < this.length; ++i)
     if (field == null && this[i] == val || field != null && this[i][field] == val)

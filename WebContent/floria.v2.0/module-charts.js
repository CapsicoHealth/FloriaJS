...
var FloriaConfig = await FloriaAjax.jsonSyncFetch("/static/json/floria-config.json?"+_STARTUP_DATE_MS);
...
/////////////pie chart initiater  
  FloriaCharts.PieChart = function(tileId, isDonut, isLabelInside) {
    ...
    chart.tooltip =  d3.select("#"+tooltipPlot)
     ...
     FloriaCharts.PieChart.prototype.addSeries = function(seriesName, seriesData, innerPercentage, innerPercentageFontSize) {
      var chart = this;
     ...
     FloriaCharts.PieChart.prototype.draw3d = function(width, inc, thickness) {
...
//                            return diff+"px";
     ...
     FloriaCharts.PieChart.prototype.addClickHandler = function(handlerFunc) { 
      var chart = this;       
     ...
     FloriaCharts.PieChart.prototype.subscribable = function() {
       var chart = this;  chart.subscribable = true;
     }
          
     FloriaCharts.PieChart.prototype.legend = function(tileId, series, horizontal, height, width) {
...
// ///////////// Chart basic setup functions
    ...
    function setAxis(chart, type, horizontal){      
      ...
      if(chart.XaxisAvailable) {
        chart.main.append("text")
            .attr("text-anchor", "end")
            .attr("transform", "translate("+ (chart.width+ chart.margin.left  + chart.margin.right - (chart.xTitle.length*4)) +","+(chart.height + chart.margin.top + chart.margin.bottom-5)+")")
            .text(chart.xTitle)
            .attr("y", 4)
            //.style("font-size","1.2em")
            .attr("text-anchor", "end");
...
// ///////////////////////// Chart initiators
    FloriaCharts.ChartBase = function(id) {
   ...
   FloriaCharts.ChartBase.prototype.setXAxis = function(title, labelFunction, labelAngle, diffAxis, LabelFontSize, ticks) {
   ...
   FloriaCharts.ChartBase.prototype.setYAxis = function(title, labelFunction, min,  max, labelAngle, diffAxis, LabelFontSize, ticks) {  
 ...
 FloriaCharts.ChartBase.prototype.addLineSeries = function(seriesName, seriesData, overrideColor, tooltip, tunerLabel, tunerValue) {  
 ...
 FloriaCharts.ChartBase.prototype.drawLine = function(line, dot) {
    var chart = this;
...
//                  console.log("-----> POPPER (3) 804")
 ...
 FloriaCharts.ChartBase.prototype.drawMarkers = function(data, vertical)
  {
...
// ////////////////////////////////////////////////////////////////////
// ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  FloriaCharts.ChartBase.prototype.addBarSeries = function(seriesName, seriesData, seriesLabels, tooltip, overrideColor) {     
    var chart = this;    
...
FloriaCharts.ChartBase.prototype.drawBar = function(horizontal)
 {
   var chart = this;
...
FloriaCharts.ChartBase.prototype.addBarClickHandler = function(handlerFunc) {
...
// ///////////////////////////////////////////////////////////////////////////
// //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    FloriaCharts.ChartBase.prototype.addScatterSeries = function(seriesName, seriesData, maxlimit, dotSize, overrideColor) {  
    ...
    FloriaCharts.ChartBase.prototype.drawScatterPlot = function() {
       var chart = this;       
       if(!chart.first){
         axisSetup(chart);
         drawLayout(chart, false, false);
...
// //////////////////////////////////////////////////////////////////////////
// ///////////////////////////////////////////////////////////////////////////////////////////////////////////
    FloriaCharts.ChartBase.prototype.addScatterOrLineClickHandler = function(handlerFunc) {
...
// /////////////////////////////////////////////////////////////////////
// /////////////////////////////////////////////////////////////////////////////////////////////////////////
    FloriaCharts.ChartBase.prototype.legend = function(tileId, series, horizontal) {
      var chartSeries = [];

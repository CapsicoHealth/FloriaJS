 ...
 */
    ...
    var build = function() {
        ...
        // RPJ-NOTE: Not useful + unable to hide this div.
    ...
    // Main Lib
export var Selectr = function(el, config) {
    ...
    Selectr.prototype.add = function(data, checkDuplicate) {
        if (data) {
            ...
            // or Selectr passed an object from an array
                ...
                // NOTE: 30/03/2018
                // Possible fix for ipad dropdown bug
                // See More: https://github.com/Mobius1/Selectr/issues/66
